...
namespace GotaSoundIO.Sound
{
    public class DspAdpcm : IAudioEncoding
    {
        ...
        public IAudioEncoding Duplicate()
        {
            ...
            ret.Context = new DspAdpcmContext()
            {
                coefs = Context.coefs,
                gain = Context.gain,
                loop_pred_scale = Context.loop_pred_scale,
                loop_yn1 = Context.loop_yn1,
                loop_yn2 = Context.loop_yn2,
                pred_scale = Context.pred_scale,
                yn1 = Context.yn1,
                yn2 = Context.yn2,
            };
            return ret;
    ...
    public class DspAdpcmEncoder
    {
        ...
        {
            byte[] dspAdpcm = GcAdpcmEncoder.Encode(
                samples,
                info.GetCoeffs(),
