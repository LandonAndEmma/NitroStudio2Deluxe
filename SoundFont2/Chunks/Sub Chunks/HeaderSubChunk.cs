...
namespace Kermalis.SoundFont2
{
    public sealed class HeaderSubChunk : SF2Chunk
    {
        ...
        internal HeaderSubChunk(SF2 inSf2, string subChunkName, string field, int maxSize = 0x100)
            : base(inSf2, subChunkName)
        {
            MaxSize = maxSize;
            Field = field;
        }

        internal HeaderSubChunk(SF2 inSf2, EndianBinaryReader reader, int maxSize = 0x100)
            : base(inSf2, reader)
        {
            MaxSize = maxSize;
